            ...
            <div class="col-md-12">
                <div class="card new-cust-card">
                    ...
                    <div class="card-body" >
                        ...
                        <?php echo form_open_multipart(site_url('ControllerAdmin/Publiciter/Admin/Modifier'));?>
                            <div>
                                <label for="" class="text-danger"><?= $i;?></label>
                            </div>
                            <div class="form-group row">
                                <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nom-Admin</label>
                                <div class="col-sm-9">
                                    <input type="text" name="modnom" class="form-control" id="exampleInputUsername2" value="<?= $ad->Nom_admin;?>" >
                                    
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Email-Admin</label>
                                <div class="col-sm-9">
                                    <input type="text" name="modemail" class="form-control" id="exampleInputUsername2" value="<?= $ad->Email_admin;?>" >
                                    
                                </div>
                            </div>
                            
                            <div class="form-group row">
                                <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Mot de Passe-Admin</label>
                                <div class="col-sm-9">
                                    <input type="text" name="modmotdepasse" class="form-control" id="exampleInputUsername2" value="<?= $ad->Motdepasse_admin;?>" >
                                    
                                </div>
                            </div>
                            <div>
                                <input type="hidden" name="idad" value="<?= $ad->idAdministrateur;?>">
                            </div>

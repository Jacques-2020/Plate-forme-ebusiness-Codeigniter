            ...
            <div class="col-md-12">
                <div class="card new-cust-card">
                    <div class="card-header">
                        <h3>Modification de Categorie</h3>
                    ...
                    <div class="card-body" >
                        ...
                        <?php echo form_open_multipart(site_url('ControllerAdmin/Produits/Categorie/Modifier'));?>
                            <div class="form-group row">
                                <label for="" class="text-danger"><?= $i;?></label>
                                <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nom</label>
                                <div class="col-sm-9">
                                    <input type="text" name="modnom" class="form-control" id="exampleInputUsername2" value="<?= $c->Nom_categorie;?>" >
                                    
                                </div>
                            </div>
                            <div>
                                <input type="hidden" name="idcat" value="<?= $c->idCategorie;?>">
                            </div>

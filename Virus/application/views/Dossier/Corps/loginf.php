                                        ...
                                        <div class="wsshoptabing wtsbrandmenu clearfix">
                                            <div class="wsshoptabingwp clearfix">
                                                <ul class="wstabitem02 clearfix">
                                                    <?php
                                                    // ceci cinsiste a afficher tous les fournisseur foreach ($fournisseur as $f) {
                                                    ?>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <?php echo form_open(site_url('Fournisseur/Login/Authentification')); ?>

                            <div class="form-group row">
                                <label for="email" class="col-sm-2 form-control-label">Email:</label>
                                <div class="col-sm-8">
                                    <input type="text" name="email" class="form-control" id="email" placeholder="Email-Fournisseur" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="password" name="motdepasse" class="form-control" id="motdepasse" placeholder="Mot de passe-Fournisseur" required />
                                </div>
                            </div>
                            ...
                            <div class="forget">
                                ...
                                <p class="pull-right">Membre..
                                    <a href="<?= site_url('Fournisseur/Compte/CreerCompte'); ?>">Créer un Nouveau Compte</a>
                                </p>
                                <div class="clearfix"></div>
                            </div>
